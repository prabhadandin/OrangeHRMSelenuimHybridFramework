...
namespace OrangeHRMHybridAutomationFramework.Tests
{
    ...
    public class LoginTest : BaseTest
    {
        ...
        public void LoginWithValidCredentials()
        {
            ...
            Assert.That(isLoaded, Is.True, $"Login failed: Dashboard URL not reached. Current URL: {driver.Value.Url}");
        ...
        public void LogoutTest()
        {
            ...
            if (isDashboardLoaded)
            {
                ...
                Assert.That(isLogoutSuccess, Is.True, $"Logout failed: Login page not reached. Current URL: {driver.Value.Url}");
                test.Value.Log(Status.Pass, "Successfully logged out.");
            }
            else
            {
                test.Value.Log(Status.Fail, $"Login failed: Dashboard not reached. Current URL: {driver.Value.Url}");
